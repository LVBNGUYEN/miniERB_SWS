...
const Sidebar: React.FC = () => {
  ...
  const getAllNavItems = () => {
    const items = [
      ...
      { icon: FileText, label: 'Hợp đồng', path: '/contracts', roles: [Role.CEO, Role.SALE] },
      { icon: FileText, label: 'Báo giá (Quotations)', path: '/quotations', roles: [Role.CEO, Role.SALE, Role.PM] },
